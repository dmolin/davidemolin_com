...
const NavBar = (_props) => {
  ...
  return (
    <div className="flex justify-between h-10 items-center px-4 relative">
      ...
      <div className="md:hidden">
        ...
        <div className={`${showMenu ? "transform -translate-x-0" : "transform translate-x-full"} fixed z-10 bg-white p-4 rounded-bl transition-all duration-500 ease-in-out right-0`}>
